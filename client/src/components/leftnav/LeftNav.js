    ...
    return (
      ...
      >
        ...
        <SubMenu key="sub2" title={<span><Icon type="appstore" /><span>汽车信息管理</span></span>}>
          ...
          <Menu.Item key="3"><Link to='add-cars'>添加新款汽车</Link></Menu.Item>
          <Menu.Item key="4"><Link to='edit-cars'>修改汽车信息</Link></Menu.Item>
        </SubMenu>
        <SubMenu key="sub3" title={<span><Icon type="setting" /><span>新闻/图片发布</span></span>}>
          <Menu.Item key="5"><Link to='news-publish'>新闻发布</Link></Menu.Item>
          <Menu.Item key="6"><Link to='pic-publish'>图片发布</Link></Menu.Item>
